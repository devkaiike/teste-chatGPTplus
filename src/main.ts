...
const createTagButton = (tag: string) => {
...
const updateTagButtons = () => {
  const buttons = Array.from(tagFilters.querySelectorAll<HTMLButtonElement>("button"));
...
const renderMenu = () => {
  ...
  menuSections.forEach((section) => {
    ...
    const grid = sectionElement.querySelector<HTMLDivElement>(".menu__grid");
